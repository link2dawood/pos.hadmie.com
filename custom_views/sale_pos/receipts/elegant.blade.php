<div style="width: 100%; color: #000000 !important;">
    ...
    <div class="row invoice-info" style="page-break-before: avoid; page-break-inside: auto !important; margin-top: 20px;">
        <div class="col-md-4 invoice-col width-40">
                                ...
                                @if($receipt_details->show_barcode || $receipt_details->show_qr_code)
                                    <div class="@if(!empty($receipt_details->footer_text)) col-xs-4 @else col-xs-12 @endif text-center">
                                        ...
                                        @if($receipt_details->show_qr_code && !empty($receipt_details->qr_code_text))
                                            <img style="width: 200px !important; height: auto; filter: contrast(150%) !important;" class="center-block mt-5" src="data:image/png;base64,{{DNS2D::getBarcodePNG($receipt_details->qr_code_text, 'QRCODE', 3, 3, [39, 48, 54])}}">
                                        @endif
                                    </div>
                                @endif
                            </div>
        ...
        <div class="col-md-8 invoice-col width-60">
