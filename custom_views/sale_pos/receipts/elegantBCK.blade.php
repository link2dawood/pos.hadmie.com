<table style="width:100%; color: #000000 !important;">
                ...
                <div class="row">
                    <div class="col-md-6 invoice-col width-50">
                        @if(!empty($receipt_details->logo))
                            <img style="max-height: 64px; width: auto;" src="{{$receipt_details->logo}}" class="img center-block pull-left">
                            <br/>
                        @endif
                    </div>
                    <div style="width: max-content;" class="pull-right col-md-6 invoice-col">
                        <h3 style="font-weight: 400; font-size: 36px !important; margin-top: 10px; color: #fff !important; background: #0DB14B !important; padding: 10px 20px; border-radius: 12px;">{!! $receipt_details->invoice_heading !!}</h3>
                    </div>
                </div>
            @endif
        </td>
    ...
    <tr>
        <td>
            ...
            {{--<hr style="color: #0DB14B; background-color: #0DB14B; height: 2px;">--}}

            <!-- business information here -->
            <div class="row invoice-info " style="background-color: #e9f3e8 !important;">

                <div class="col-md-6 invoice-col width-25 ">
                    ...
                    @if(!empty($receipt_details->total_due) && !empty($receipt_details->total_due_label))
                        <div class=".bg-gray-active text-right font-23 padding-5">
				<span class="pull-left .bg-gray-active">
                ...
                <div class="col-md-6 invoice-col width-25 ">
                    @if(empty($receipt_details->letter_head))
                        <!-- Logo -->
                        {{--@if(!empty($receipt_details->logo))
                            <img style="max-height: 65px; width: auto;" src="{{$receipt_details->logo}}" class="img center-block">
                            <br/>
                        @endif--}}
            ...
            @if(!empty($receipt_details->shipping_custom_field_5_label))
                <div class="row">
                    <div clas: #0DB14B !important; color: white !important; width: 15% !important;">
                                {{$receipt_details->table_unit_price_label}}
                            </td>
                            @if(!empty($receipt_details->discounted_unit_price_label))
                                <td style="background-color: #0DB14B !important; color: white !important; width: 10% !important;">
                        ...
                        @foreach($receipt_details->lines as $line)
                            <tr>
                                ...
                                @endif  {{--unit cost with taxes column--}}
            ...
            <div class="row invoice-info " style="page-break-inside: avoid !important">
                <div class="col-md-6 invoice-col width-50">
                    ...
                    <b class="pull-right">{{__('lang_v1.authorized_signatory')}}</b>
                </div>
                ...
                <div class="col-md-6 invoice-col width-50">
                    <table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
                        ...
                        <!-- Total -->
                        <tr>
                            <th style="background-color: #0DB14B !important; color: white !important" class="font-23 padding-10">
                                {!! $receipt_details->total_label !!}
                            </th>
                            <td class="text-right font-23 padding-10" style="background-color: #0DB14B !important; color: white !important">
                        ...
                        <tr>
                            <td>
                                <!-- Total Paid in the edited INV-->
                                @if(!empty($receipt_details->total_paid))
                                    <div class="text-right tw-text-lg tw-font-medium ">
                                        <span class="pull-left">{!! $receipt_details->total_paid_label !!}</span>
                                        {{$receipt_details->total_paid}}
                                    </div>
                                @endif
                ...
                @if($receipt_details->show_barcode || $receipt_details->show_qr_code)
                    <div class="@if(!empty($receipt_details->footer_text)) col-xs-4 @else col-xs-12 @endif text-center">
                        ...
                        @if($receipt_details->show_qr_code && !empty($receipt_details->qr_code_text))
                            <img class="center-block mt-5 pull-right" src="data:image/png;base64,{{DNS2D::getBarcodePNG($receipt_details->qr_code_text, 'QRCODE', 3, 3, [39, 48, 54])}}">
                        @endif
                    </div>
                @endif
            </div>
