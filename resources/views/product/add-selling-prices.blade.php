	...
	<div class="row">
		...
		<div class="box box-solid">
			<div class="box-header">
	            <h4 class="box-title">@lang('sale.product'): {{$product->name}} ({{$product->sku}})</h4>
	        </div>
			<div class="box-body">
				<div class="row">
					<div class="col-xs-12">
						<div class="table-responsive">
							<table class="table table-condensed table-bordered table-th-green text-center-setm table-striped">
								<thead>
									<tr>
