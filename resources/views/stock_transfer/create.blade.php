                ...
                <div class="col-sm-10 col-sm-offset-1">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-condensed" id="stock_adjustment_product_table">
                            <thead>
                                <tr>
                                    <th class="col-sm-4 text-center-setm">
                                        @lang('sale.product')
                                    </th>
                                    <th class="col-sm-2 text-center-setm">
                                        @lang('sale.qty')
                                    </th>
                                    <th class="col-sm-2 text-center-setm show_price_with_permission">
                                        @lang('sale.unit_price')
                                    </th>
                                    <th class="col-sm-2 text-center-setm show_price_with_permission">
                                        @lang('sale.subtotal')
                                    </th>
                                    <th class="col-sm-2 text-center-setm"><i class="fa fa-trash" aria-hidden="true"></i></th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
                            <tfoot>
                                <tr class="text-center-setm show_price_with_permission">
                                    <td colspan="3"></td>
                                    <td>
