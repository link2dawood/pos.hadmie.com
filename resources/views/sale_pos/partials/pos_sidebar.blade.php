            ...
            <div class="tw-dw-drawer tw-dw-drawer-end">
                ...
                <div class="tw-dw-drawer-content">
                    ...
                    <label for="my-drawer-4"
                        class="tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 hover:tw-from-indigo-600 hover:tw-to-blue-600 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-blue-500 focus:tw-ring-offset-2 active:tw-from-indigo-700 active:tw-to-blue-700 lg:tw-w-[60%] tw-w-full tw-flex tw-items-center tw-justify-center tw-gap-1 tw-text-base md:tw-text-base tw-text-white tw-font-normal tw-rounded-xl tw-h-10 tw-cursor-pointer">
