...
<div class="row">
	<div class="col-sm-12 pos_product_div">
		...
		<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
			<thead>
				<tr>
					<th class=".text-center-setm tw-text-sm md:!tw-text-base tw-font-medium @if(!empty($pos_settings['inline_service_staff'])) col-md-3 @else col-md-4 @endif">
						@lang('sale.product') @show_tooltip(__('lang_v1.tooltip_sell_product_column'))
					</th>
					<th class=".text-center-setm tw-text-sm md:!tw-text-base tw-font-medium col-md-3">
						@lang('sale.qty')
					</th>
					@if(!empty($pos_settings['inline_service_staff']))
						<th class=".text-center-setm tw-text-sm md:!tw-text-base tw-font-medium col-md-2">
							@lang('restaurant.service_staff')
						</th>
					@endif
					<th class=".text-center-setm tw-text-sm md:!tw-text-base tw-font-medium col-md-2 {{$hide_tax}}">
						@lang('sale.price_inc_tax')
					</th>
					<th class=".text-center-setm tw-text-sm md:!tw-text-base tw-font-medium col-md-2">
						@lang('sale.subtotal')
					</th>
					<th class=".text-center-setm"><i class="fas fa-times tw-text-sm" aria-hidden="true"></i></th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
