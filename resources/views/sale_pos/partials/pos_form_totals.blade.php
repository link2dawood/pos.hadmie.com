<div class="row pos_form_totals">
	<div class="col-md-12">
		<table class="table table-condensed">
			<tr>
				<td><b class="tw-text-base md:tw-text-lg tw-font-normal">@lang('sale.item'):</b>&nbsp;
					<span class="total_quantity tw-text-base md:tw-text-lg tw-font-bold">0</span></td>
				<td>
					<b class="tw-text-base md:tw-text-lg tw-font-normal">@lang('sale.total'):</b> &nbsp;
					<span class="price_total tw-text-base md:tw-text-lg tw-font-bold">0</span>
				</td>
			</tr>
			<tr>
				@if(!Gate::check('disable_discount') || auth()->user()->can('superadmin') || auth()->user()->can('admin'))
					<td>
						<b class="tw-text-base md:tw-text-lg tw-font-normal">
							...
							@if($is_discount_enabled)
								...
								<span class="tw-text-base md:tw-text-lg tw-font-bold" id="total_discount">0</span>
							@endif
				...
				<td class="@if($pos_settings['disable_order_tax'] != 0) hide @endif">
					<span class="tw-text-base md:tw-text-lg tw-font-bold">
						<b class="tw-text-base md:tw-text-lg tw-font-normal">@lang('sale.order_tax')(+): @show_tooltip(__('tooltip.sale_tax'))</b>
						...
						<span class="tw-text-base md:tw-text-lg tw-font-bold" id="order_tax">
							@if(empty($edit))
								0
							@else
				...
				<td>
					<span class="tw-text-base md:tw-text-lg tw-font-bold">
						...
						<b class="tw-text-base md:tw-text-lg tw-font-normal">@lang('sale.shipping')(+): @show_tooltip(__('tooltip.shipping'))</b>
				...
				@if(in_array('types_of_service', $enabled_modules))
					<td class="col-sm-3 col-xs-6 d-inline-table">
						<b class="tw-text-base md:tw-text-lg tw-font-normal">@lang('lang_v1.packing_charge')(+):</b>
						<i class="fas fa-edit cursor-pointer service_modal_btn"></i> 
						<span  class="tw-text-base md:tw-text-lg tw-font-bold" id="packing_charge_text">
							0
						</span>
					</td>
				@endif
				...
				<td>
					<b class="tw-text-base md:tw-text-lg tw-font-normal" id="round_off">@lang('lang_v1.round_off'):</b> <span id="round_off_text">0</span>
