<div style="width: 100%; color: #000000 !important; font-family: Arial, sans-serif;">
    ...
    <div style="margin-bottom: 25px;">
        <h3 style="font-size: 18px; font-weight: bold; margin-bottom: 15px;">Tax Breakdown</h3>
        <table style="width: 100%; border-collapse: collapse; background-color: #f8f9fa; border: 2px solid #000;">
            <thead>
                <tr style="background-color: #e9ecef;">
                    <th style="padding: 12px; font-weight: bold; text-align: left;">Tax Name</th>
                ...
                <tr>
                    <td style="padding: 12px; border-bottom: 1px solid #ddd;">{{ $tax['name'] }}</td>
                    <td style="padding: 12px; text-align: right; border-bottom: 1px solid #ddd;">{{ $tax['rate'] }}%</td>
                    <td style="padding: 12px; text-align: right; border-bottom: 1px solid #ddd;">{{ $tax['amount'] }}</td>
                    </tr>
                @endforeach
                </tbody>
            </table>
    ...
    <div style="margin-bottom: 25px;">
        <table style="width: 100%; border-collapse: collapse; background-color: #f8f9fa; border: 2px solid #000;">
            ...
            <tr>
                    <td style="padding: 12px; font-size: 18px;">Discount</td>
