...
<body>
    <div class="header">
        ...
        <div class="invoice-title">
            @if(!empty($sub_status) && $sub_status == 'proforma')
                PROFORMA INVOICE
            @else
                QUOTATION
            @endif
        ...
        <table style="border: none;">
            <tr style="border: none;">
                <td style="border: none; width: 50%;">
                    <strong>Quotation No:</strong> {{ $receipt_details->invoice_no }}<br>
    ...
    <div style="margin-top: 30px; text-align: center; font-size: 11px; color: #666;">
        ...
        <p>This is a quotation and does not constitute an invoice until payment is received.</p>
    </div>
</body>
</html>
