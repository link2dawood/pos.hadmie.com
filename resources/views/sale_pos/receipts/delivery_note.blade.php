<div style="width: 100%; color: #000000 !important; font-family: Arial, sans-serif;padding: 10px;">
    ...
    <div style="margin-bottom: 25px;">
        <table style="width: 100%; border-collapse: collapse;align-items: center;">
            <tr>
                <td style="padding: 8px 0; font-weight: bold; width: 33%; font-size: 20px;">DELIVERY NOTE NUMBER</td>
    ...
    <div style="margin-bottom: 25px;">
        <table style="width: 100%; border-collapse: collapse; border-top: 2px solid #000;">
                ...
                <tr style="background-color: #f8f9fa;">
                    ...
                    <th style="padding: 12px 8px; text-align: center; font-weight: bold; border-bottom: 1px solid #ddd; font-size: 20px;">Delivered</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 12px 8px; text-align: center; border-bottom: 1px solid #eee; font-size: 22px;">
                        <span style="background-color: #28a745; color: white; padding: 4px 8px; border-radius: 4px; font-size: 22px;">DELIVERED</span>
                                    </td>
                                </tr>
                            @endforeach
                </tbody>
    ...
    <div style="margin-bottom: 25px;">
        <table style="width: 100%; border-collapse: collapse; background-color: #f8f9fa; border: 2px solid #000;">
            <tr style="background-color: #e9ecef;">
                <td style="padding: 12px; font-weight: 500; width: 50%; font-size: 22px;">Total Items</td>
    ...
    <div style="margin-bottom: 25px;">
        <div style="font-weight: 500; margin-bottom: 10px;font-size:22px">Delivery Address:</div>
    ...
    <div style="margin-bottom: 25px;">
        <div style="font-weight: 500; margin-bottom: 10px;font-size:22px;">Delivery Instructions:</div>
        <div style="font-size: 20px; color: #666; background-color: #f8f9fa; padding: 15px; border-radius: 5px;">
            Please ensure all items are checked and signed for upon delivery. Contact customer if any issues arise.
        </div>
    </div>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td style="padding: 20px; text-align: center; border: 1px solid #ddd;">
                    <div style="font-weight: 500; margin-bottom: 10px;font-size: 22px;">Customer Signature</div>
                    <div style="height: 50px; border-bottom: 1px solid #000;"></div>
                    <div style="margin-top: 5px; font-size: 22px;">Date: _______________</div>
                        </td>
                <td style="padding: 20px; text-align: center; border: 1px solid #ddd;">
                    <div style="font-weight: bold; margin-bottom: 10px;font-size: 22px;">Driver Signature</div>
                    <div style="height: 50px; border-bottom: 1px solid #000;"></div>
                    <div style="margin-top: 5px; font-size: 22px;">Date: _______________</div>
                            </td>
                        </tr>
    ...
    <div style="text-align: center; margin-top: 30px; font-size: 22px;">
        <div style="font-weight: bold;">
            Delivered By: {{ $receipt_details->sold_by ?? 'System' }}
        </div>
