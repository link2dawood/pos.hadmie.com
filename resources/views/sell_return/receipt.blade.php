	...
	<thead>
		<tr>
			...
			@if(!empty($receipt_details->invoice_heading))
				<p class="text-right text-muted-imp" style="font-weight: bold; font-size: 20px !important">{!! $receipt_details->invoice_heading !!}</p>
			@endif

			<p class="text-right" style="font-size: 20px !important">
...
@if(!empty($receipt_details->header_text))
	<div class="row invoice-info" style="font-size: 20px !important">
		<div class="col-xs-12">
...
<div class="row invoice-info" style="font-size: 20px !important">
	...
	<div class="col-md-6 invoice-col width-50" style="font-size: 20px !important">

		<p class="text-right font-30" style="font-size: 20px !important">
			@if(!empty($receipt_details->invoice_no_prefix))
...
<div class="row invoice-info color-555" style="font-size: 20px !important">
	<br/>
	<div class="col-md-6 invoice-col width-50 word-wrap" style="font-size: 20px !important">
		<b style="font-size: 20px !important">{{ $receipt_details->customer_label ?? '' }}</b><br/>
		...
		<table class="table table-bordered table-no-top-cell-border">
			<thead>
				<tr style="background-color: #357ca5 !important; color: white !important; font-size: 20px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
					...
					<td style="background-color: #357ca5 !important; color: white !important; width: 15% !important"></td>
...
<div class="row invoice-info color-555" style="page-break-inside: avoid !important">
	...
	<div class="col-md-6 invoice-col width-50">
		<table class="table-no-side-cell-border table-no-top-cell-border width-100">
			<tbody>
				<tr class="color-555" style="font-size: 20px !important">
					<td style="width:50%">
...
<div class="row color-555" style="font-size: 20px !important">
	<div class="col-xs-6" style="font-size: 20px !important">
		<div style="font-size: 20px !important">{{$receipt_details->additional_notes}}</div>
	</div>
...
@if(!empty($receipt_details->footer_text))
	<div class="row color-555" style="font-size: 20px !important">
		<div class="col-xs-12" style="font-size: 20px !important">
			<div style="font-size: 20px !important">{!! $receipt_details->footer_text !!}</div>
		</div>
	</div>
@endif
