...
{!! Form::open(['url' => action([\App\Http\Controllers\InvoiceLayoutController::class, 'update'], [$invoice_layout->id]), 'method' => 'put', 
  ...
  @php
    ...
    $print_settings = $invoice_layout->common_settings['print'] ?? [];
    $resolved_paper_size = $print_settings['paper_size'] ?? ($invoice_layout->design == 'slim' ? 'thermal-80' : ($invoice_layout->design == 'slim2' ? 'thermal-58' : 'a4'));
    $print_section_order = $print_settings['section_order'] ?? 'brand_header,company,party,document_meta,items,totals,notes,terms,signatures,codes,footer';
    $print_documents = [
      'invoice' => 'Invoice',
              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    ], $resolved_paper_size, ['class' => 'form-control', 'id' => 'print_paper_size']); !!}
                  </div>
                </div>
                <div class="col-sm-4">
                  <div class="form-group">
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    {!! Form::text('common_settings[print][section_order]', $print_section_order, ['class' => 'form-control', 'id' => 'section_order', 'placeholder' => $print_section_order]); !!}
                ...
                <div class="col-sm-12">
                  <div class="well well-sm" id="print_settings_preview">
                    ...
                    <span data-preview="paper"></span> |
                    <span data-preview="template"></span> |
                    <span data-preview="sections"></span> |
                    <span data-preview="documents"></span>
                  </div>
                </div>
              </div>
            </div>
