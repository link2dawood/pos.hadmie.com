	...
	<div class="col-sm-12">
		...
		<div class="box box-solid">
			<div class="box-header">
	            <h4 class="box-title">@lang('sale.location'): {{$value}}</h4>
	        </div>
			<div class="box-body">
				<div class="row tw-overflow-scroll">
					<div class="col-sm-12">
						<table class="table table-condensed table-bordered text-center-setm table-responsive table-striped add_opening_stock_table">
								<thead>
								<tr class="bg-green">
...
@endif
	...
	@endforeach
		...
		@empty
    		<h4>@lang( 'lang_v1.product_not_assigned_to_any_location' )</h4>
		@endforelse
	</div>
</div>