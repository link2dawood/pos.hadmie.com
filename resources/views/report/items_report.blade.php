...
<section class="content">
    ...
    <tr class="bg-gray font-17 text-center footer-total">
        <td><strong>@lang('sale.total'):</strong></td> <!-- 1 -->
        ...
        <td id="footer_total_pp"
            ...
            data-currency_symbol="true"></td> <!-- 7 -->
        ...
        <td id="footer_total_qty"></td> <!-- 13 -->

        <td id="footer_total_sp"
            class="display_currency"
            data-currency_symbol="true"></td> <!-- 14 -->

        <td id="footer_total_subtotal"
            class="display_currency"
            data-currency_symbol="true"></td> <!-- 15 -->
    </tr>
</tfoot>
