                                    ...
                                    <div class="tw-flex-1 tw-min-w-0">
                                        ...
                                        <p
                                            ...
                                            <i class="fa fa-info-circle text-info hover-q no-print" aria-hidden="true" data-container="body"
                                               data-toggle="popover" data-placement="auto bottom" id="total_srp2"
                                               data-value="{{ __('lang_v1.net_home_tooltip') }}"
                                ...
                                <div class="tw--mx-4 tw--my-2 tw-overflow-x-auto sm:tw--mx-5">
                                    <div class="tw-inline-block tw-min-w-full tw-py-2 tw-align-middle sm:tw-px-5">
                                        <table class="table table-bordered table-striped" id="sales_payment_dues_table"
                                            style="width: 100%; font-size: .85rem; font-weight: 300;">
                                            <thead>
                                                <tr>
                                ...
                                <div class="tw--mx-4 tw--my-2 tw-overflow-x-auto sm:tw--mx-5">
                                    <div class="tw-inline-block tw-min-w-full tw-py-2 tw-align-middle sm:tw-px-5">
                                        <table class="table table-bordered table-striped ajax_view"
                                            id="sales_order_table" style="width: 100%; font-size: .85rem; font-weight: 300;">
                                            <thead>
                                                <tr>
                                                    <th>@lang('messages.action')</th>
                        ...
                        <div class="tw-p-4 sm:tw-p-5">
                            ...
                            <div class="tw-flow-root tw-mt-5  tw-border-gray-200">
                                <div class="tw--mx-4 tw--my-2 tw-overflow-x-auto sm:tw--mx-5">
                                    <div class="tw-inline-block tw-min-w-full tw-py-2 tw-align-middle sm:tw-px-5">
                                        <table class="table table-bordered table-striped ajax_view"
                                            id="purchase_requisition_table" style="width: 100%; font-size: .85rem; font-weight: 300;">
                                            <thead>
                                                <tr>
                                                    <th>@lang('messages.action')</th>
                                                    <th>@lang('messages.date')</th>
                        ...
                        <div class="tw-p-4 sm:tw-p-5">
                            ...
                            <div class="tw-flow-root tw-mt-5  tw-border-gray-200">
                                <div class="tw--mx-4 tw--my-2 tw-overflow-x-auto sm:tw--mx-5">
                                    <div class="tw-inline-block tw-min-w-full tw-py-2 tw-align-middle sm:tw-px-5">
                                        <table class="table table-bordered table-striped ajax_view"
                                            id="purchase_order_table" style="width: 100%; font-size: .85rem; font-weight: 300;">
                                            <thead>
                                                <tr>
                                                    <th>@lang('messages.action')</th>
                                                    <th>@lang('messages.date')</th>
