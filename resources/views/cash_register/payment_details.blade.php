  ...
  <div class="col-sm-12">
    ...
    <table class="table table-condensed">
      ...
      <tr class="success">
        ...
        <td>
          @php
            $total_payments = $register_details->cash_in_hand + $register_details->total_cash + $register_details->total_card + $register_details->total_cheque + $register_details->total_bank_transfer + $register_details->total_advance + $register_details->total_custom_pay_1 + $register_details->total_custom_pay_2 + $register_details->total_custom_pay_3 + $register_details->total_custom_pay_4 + $register_details->total_custom_pay_5 + $register_details->total_custom_pay_6 + $register_details->total_custom_pay_7 + $register_details->total_other - $register_details->total_refund;
          @endphp
          <b><span class="display_currency" data-currency_symbol="true">{{ $total_payments }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ $details['transaction_details']->total_sales - $total_payments }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
