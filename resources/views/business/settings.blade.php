    ...
    <div class="row">
       ...
       <!--  <pos-tab-container> -->
        ...
        @component('components.widget', ['class' =>  'pos-tab-container'])
                {{--removed class col-xs-2--}}
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4 pos-tab-menu tw-rounded-lg">
                <div class="list-group">
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base  active">@lang('business.business')</a>
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base">@lang('business.tax') @show_tooltip(__('tooltip.business_tax'))</a>
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base">@lang('business.product')</a>
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base">@lang('contact.contact')</a>
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base">@lang('business.sale')</a>
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base">@lang('sale.pos_sale')</a>
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base">@lang('purchase.purchases')</a>
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base">@lang('lang_v1.payment')</a>
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base">@lang('business.dashboard')</a>
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base">@lang('business.system')</a>
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base">@lang('lang_v1.prefixes')</a>
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base">@lang('lang_v1.email_settings')</a>
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base">@lang('lang_v1.sms_settings')</a>
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base">@lang('lang_v1.reward_point_settings')</a>
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base">@lang('lang_v1.modules')</a>
                    <a href="#posTabSettings" class="list-group-item text-center-setm tw-font-normal tw-text-sm md:tw-text-base">@lang('lang_v1.custom_labels')</a>
                </div>
            </div>
            <div id="posTabSettings" class="col-lg-10 col-md-10 col-sm-10 col-xs-8 pos-tab">
                <!-- tab 1 start -->
