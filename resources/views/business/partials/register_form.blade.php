...
<div class="col-md-12">
    <div class="form-group">
        ...
        @show_tooltip(__('business.business_type_help'))
        <div class="input-group">
            <span class="input-group-addon">
                <i class="fa fa-building"></i>
            </span>
            {!! Form::select('business_type', $business_type_options, '', ['class' => 'form-control select2_register','placeholder' => __('business.select_business_type'), 'required']); !!}
        </div>
    </div>
</div>
<div class="clearfix"></div>
<div class="col-md-6">
    <div class="form-group form-control-uploadButton">
