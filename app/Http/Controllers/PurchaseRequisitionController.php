...
class PurchaseRequisitionController extends Controller
{
    ...
    /**
     * Return a single requisition product row for selected product/variation & location.
     */
    public function getRequisitionProductRow(Request $request)
    {
        if ($request->ajax()) {
            $business_id = $request->session()->get('user.business_id');
            $location_id = $request->input('location_id');
            ...
            return view('purchase_requisition.partials.requisition_product_row')
