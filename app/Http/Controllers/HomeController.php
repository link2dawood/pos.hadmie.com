...
class HomeController extends Controller
{
    ...
    public function getTotals()
    {
        if (request()->ajax()) {
            ...
            // Show gross sales on dashboard and keep returns separate
            ...
            // NET = (GROSS SALES - RETURNS) - INVOICE DUE - EXPENSE
            $output['net'] = ($output['total_sell'] - $output['total_sell_return']) - $output['invoice_due'] - $output['total_expense'];
