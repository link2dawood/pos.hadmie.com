...
function __print_receipt(section_id = null) {
    console.log('__print_receipt called with section_id:', section_id);
    
    // Always trigger print immediately - like Ctrl+P behavior
    setTimeout(function() {
        console.log('Calling window.print()');
        window.print();
    }, 500); // Reduced delay for faster printing
    
    // Legacy image loading code (commented out for immediate printing)
    /*
    if (section_id) {
